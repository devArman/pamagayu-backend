...
@section('content')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            // For small files (< 5MB), let the form submit normally
        ...
        function submitFormWithPaths(paths) {
            ...
            // Remove the file inputs from form data
            ...
            fetch(form.action, {
                ...
                showError('Network error while saving post. Files were uploaded successfully — try creating the post again.');
            });
        }
